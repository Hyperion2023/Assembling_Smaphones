        ...
        for row_index,row in enumerate(matrix):
            ...
            for col_index,col in enumerate(row):
                ...
                if col_index!=len(row)-1:
                        ...
                        if not (matrix[row_index][col_index+1]==(1, 0, 0)).all() and not (matrix[row_index][col_index]==(1, 0, 0)).all() :# If im not a mounting point
                ...
                if row_index!=len(matrix)-1:
                    ...
                    if not (matrix[row_index+1][col_index]==(1, 0, 0)).all() and not (matrix[row_index][col_index]==(1, 0, 0)).all():# If im not a mounting point
...
def dijkstra(aGraph, start, target):
    ...
    while len(unvisited_queue):
        ...
        for next in current.adjacent:
            ...
            #     print("updated : current = "+str(current.get_id())+" next ="+str(next.get_id())+" new_dist = "+str( next.get_distance()))
            # else:
            #     print("not updated : current = "+str(current.get_id())+" next ="+str(next.get_id())+" new_dist = "+str( next.get_distance()))
